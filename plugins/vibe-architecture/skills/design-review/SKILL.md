---
name: design-review
description: Evaluate design docs against vibe coding axes, Grade (S~F) and Score (0-100). ALWAYS consult this skill when user mentions: review, score, grade, rate, audit, check design — "설계 리뷰", "점수", "검토", "괜찮아?", "FAIL?", design quality, ready to implement.
---
