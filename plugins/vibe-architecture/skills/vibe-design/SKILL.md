---
name: vibe-design
description: Specialized vibe coding design methodology — right amount of spec, no over/under-specification. ALWAYS consult this skill when user mentions: design, plan, architect, brainstorm, spec — "설계해줘", "아키텍처 잡아줘", "어떻게 만들면 좋을까", "spec 필요해?", "설계 문서".
---
